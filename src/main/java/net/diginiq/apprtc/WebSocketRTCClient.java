...
import net.diginiq.apprtc.WebSocketChannelClient.WebSocketChannelEvents;
import net.diginiq.apprtc.WebSocketChannelClient.WebSocketConnectionState;
import net.diginiq.apprtc.util.AsyncHttpURLConnection;
 ...
 */
public class WebSocketRTCClient implements net.diginiq.apprtc.AppRTCClient, WebSocketChannelEvents {
  ...
  private net.diginiq.apprtc.WebSocketChannelClient wsClient;
  ...
  private void connectToRoomInternal() {
    ...
    roomState = ConnectionState.NEW;
    wsClient = new net.diginiq.apprtc.WebSocketChannelClient(handler, this);

    net.diginiq.apprtc.RoomParametersFetcher.RoomParametersFetcherEvents callbacks = new net.diginiq.apprtc.RoomParametersFetcher.RoomParametersFetcherEvents() {
      @Override
    ...
    new net.diginiq.apprtc.RoomParametersFetcher(connectionUrl, null, callbacks).makeRequest();
  }
