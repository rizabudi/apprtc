...
import net.diginiq.apprtc.AppRTCClient.SignalingParameters;
...
public class PeerConnectionClient {
  ...
  private boolean renderLocalVideo = true;
  @Nullable
  ...
  @Nullable private net.diginiq.apprtc.RecordedAudioToFileController saveRecordedAudioToFile;
  ...
  private void createPeerConnectionFactoryInternal(PeerConnectionFactory.Options options) {
    ...
    if (peerConnectionParameters.saveInputAudioToFile) {
      if (!peerConnectionParameters.useOpenSLES) {
        ...
        saveRecordedAudioToFile = new net.diginiq.apprtc.RecordedAudioToFileController(executor);
      } else {
  ...
  private VideoTrack createVideoTrack(VideoCapturer capturer) {
    ...
    localVideoTrack.setEnabled(renderVideo && renderLocalVideo);
