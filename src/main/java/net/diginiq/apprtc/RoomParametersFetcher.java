...
public class RoomParametersFetcher {
  ...
  public interface RoomParametersFetcherEvents {
     ...
     */
    void onSignalingParametersReady(final net.diginiq.apprtc.AppRTCClient.SignalingParameters params);
  ...
  private void roomHttpResponseParse(String response) {
    ...
    try {
      ...
      net.diginiq.apprtc.AppRTCClient.SignalingParameters params = new net.diginiq.apprtc.AppRTCClient.SignalingParameters(
  ...
  private List<PeerConnection.IceServer> requestTurnServers(String url)
    ...
    connection.setRequestProperty("REFERER", "https://apprtc.diginiq.app");
